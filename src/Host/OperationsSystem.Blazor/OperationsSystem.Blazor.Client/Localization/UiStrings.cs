...
public static class UiStrings
{
    ...
    public static class Dashboard
    {
        ...
        public static string ControlCenter => UiText.Get("Dashboard.ControlCenter", "Operations control center");
        public static string WelcomeTitle => UiText.Get("Dashboard.WelcomeTitle", "Welcome back, {0}");
        public static string Description => UiText.Get("Dashboard.Description", "A live view of flights, work orders, and master data within your access scope.");
        public static string Live => UiText.Get("Dashboard.Live", "Live");
        public static string Stale => UiText.Get("Dashboard.Stale", "Update issue");
        public static string UpdatedFormat => UiText.Get("Dashboard.UpdatedFormat", "Updated {0}");
        public static string WaitingForData => UiText.Get("Dashboard.WaitingForData", "Waiting for the first update");
        public static string AutoRefresh => UiText.Get("Dashboard.AutoRefresh", "Auto-refreshes every 30 seconds");
        public static string RefreshData => UiText.Get("Dashboard.RefreshData", "Refresh data");
        public static string MasterDataTitle => UiText.Get("Dashboard.MasterDataTitle", "Master data");
        public static string MasterDataDescription => UiText.Get("Dashboard.MasterDataDescription", "Active records powering planning and daily operations.");
        public static string ActiveRecords => UiText.Get("Dashboard.ActiveRecords", "Active records");
        public static string OperationsTitle => UiText.Get("Dashboard.OperationsTitle", "Flight operations");
        public static string OperationsDescription => UiText.Get("Dashboard.OperationsDescription", "Current status across every flight visible in your scope.");
        public static string Scheduled => UiText.Get("Dashboard.Scheduled", "Scheduled");
        public static string ScheduledHint => UiText.Get("Dashboard.ScheduledHint", "In the operations queue");
        public static string InProgress => UiText.Get("Dashboard.InProgress", "In progress");
        public static string InProgressHint => UiText.Get("Dashboard.InProgressHint", "Being handled now");
        public static string Completed => UiText.Get("Dashboard.Completed", "Completed");
        public static string CompletedHint => UiText.Get("Dashboard.CompletedHint", "Successfully closed");
        public static string Canceled => UiText.Get("Dashboard.Canceled", "Canceled");
        public static string CanceledHint => UiText.Get("Dashboard.CanceledHint", "Canceled operations");
        public static string FlightMix => UiText.Get("Dashboard.FlightMix", "Flight status mix");
        public static string FlightMixDescription => UiText.Get("Dashboard.FlightMixDescription", "All visible flights by current status.");
        public static string TotalFlights => UiText.Get("Dashboard.TotalFlights", "Total flights");
        public static string LiveBoardTitle => UiText.Get("Dashboard.LiveBoardTitle", "Live flight board");
        public static string LiveBoardDescription => UiText.Get("Dashboard.LiveBoardDescription", "Scheduled and in-progress flights in the next 48 hours.");
        public static string Flight => UiText.Get("Dashboard.Flight", "Flight");
        public static string Customer => UiText.Get("Dashboard.Customer", "Customer");
        public static string Station => UiText.Get("Dashboard.Station", "Station");
        public static string Arrival => UiText.Get("Dashboard.Arrival", "Arrival");
        public static string NoActiveFlights => UiText.Get("Dashboard.NoActiveFlights", "No scheduled or in-progress flights in this window.");
        public static string WorkOrdersTitle => UiText.Get("Dashboard.WorkOrdersTitle", "Work order lifecycle");
        public static string WorkOrdersDescription => UiText.Get("Dashboard.WorkOrdersDescription", "Live workload and approval progress across the work orders you can access.");
        public static string Submitted => UiText.Get("Dashboard.Submitted", "Submitted");
        public static string SubmittedHint => UiText.Get("Dashboard.SubmittedHint", "Awaiting review");
        public static string Returned => UiText.Get("Dashboard.Returned", "Returned");
        public static string ReturnedHint => UiText.Get("Dashboard.ReturnedHint", "Requires changes");
        public static string Approved => UiText.Get("Dashboard.Approved", "Approved");
        public static string ApprovedHint => UiText.Get("Dashboard.ApprovedHint", "Ready and numbered");
        public static string Merged => UiText.Get("Dashboard.Merged", "Merged");
        public static string MergedHint => UiText.Get("Dashboard.MergedHint", "Combined records");
        public static string RecentActivity => UiText.Get("Dashboard.RecentActivity", "Recent work orders");
        public static string RecentActivityDescription => UiText.Get("Dashboard.RecentActivityDescription", "Newest lifecycle changes in your scope.");
        public static string NoRecentWorkOrders => UiText.Get("Dashboard.NoRecentWorkOrders", "No work orders have been created yet.");
        public static string PartialDataWarning => UiText.Get("Dashboard.PartialDataWarning", "Some live data could not be refreshed. The last successful values are still shown.");
        public static string AccountHomeTitle => UiText.Get("Dashboard.AccountHomeTitle", "Your workspace is ready");
        public static string AccountHomeDescription => UiText.Get("Dashboard.AccountHomeDescription", "Your role does not include operational or master-data dashboards. You can still manage your profile and account security.");
        public static string ScheduleFlight => UiText.Get("Dashboard.ScheduleFlight", "Schedule flight");
        public static string CreateWorkOrder => UiText.Get("Dashboard.CreateWorkOrder", "Create work order");
