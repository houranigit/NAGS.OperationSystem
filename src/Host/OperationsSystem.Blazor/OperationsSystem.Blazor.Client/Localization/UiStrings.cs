...
public static class UiStrings
{
    public static class App
    {
        ...
        public static string Version => UiText.Get("App.Version", "v1.0.6");
    }
    ...
    {
        public static string NavLabel => UiText.Get("OperationsDashboard.NavLabel", "Operations dashboard");
        public static string Title => UiText.Get("OperationsDashboard.Title", "Operations dashboard");
        public static string ExecutiveOverview => UiText.Get("OperationsDashboard.ExecutiveOverview", "Executive overview");
        public static string ControlCenter => UiText.Get("OperationsDashboard.ControlCenter", "Operations control center");
        public static string Description => UiText.Get("OperationsDashboard.Description", "Monitor flight activity, service delivery, and performance across your operational scope.");
        public static string RealtimeDescription => UiText.Get("OperationsDashboard.RealtimeDescription", "Operational changes appear here as they happen.");
        ...
        public static string LastMonth => UiText.Get("OperationsDashboard.LastMonth", "Last month");
        public static string LastThreeMonths => UiText.Get("OperationsDashboard.LastThreeMonths", "Last 3 months");
        public static string Max => UiText.Get("OperationsDashboard.Max", "Max");
        public static string AllAvailableHistory => UiText.Get("OperationsDashboard.AllAvailableHistory", "All available history");
        public static string FilterTitle => UiText.Get("OperationsDashboard.FilterTitle", "Refine your operational view");
        public static string FilterDescription => UiText.Get("OperationsDashboard.FilterDescription", "Filter all dashboard metrics, charts, and flight records from one place.");
        public static string ActiveFiltersFormat => UiText.Get("OperationsDashboard.ActiveFiltersFormat", "Active filters: {0}");
        public static string DateMode => UiText.Get("OperationsDashboard.DateMode", "Date range");
        public static string CalendarTitle => UiText.Get("OperationsDashboard.CalendarTitle", "Date selection");
        public static string Day => UiText.Get("OperationsDashboard.Day", "Day");
        public static string Range => UiText.Get("OperationsDashboard.Range", "Range");
        public static string SelectDay => UiText.Get("OperationsDashboard.SelectDay", "Select a day to update the dashboard.");
        public static string SelectRangeStart => UiText.Get("OperationsDashboard.SelectRangeStart", "Select the first day of the range.");
        public static string SelectRangeEnd => UiText.Get("OperationsDashboard.SelectRangeEnd", "Now select the last day of the range.");
        public static string RangeSelected => UiText.Get("OperationsDashboard.RangeSelected", "Select another day to start a new range.");
        public static string Yesterday => UiText.Get("OperationsDashboard.Yesterday", "Yesterday");
        public static string SingleDay => UiText.Get("OperationsDashboard.SingleDay", "Single day");
        public static string Period => UiText.Get("OperationsDashboard.Period", "Custom period");
        public static string LiveData => UiText.Get("OperationsDashboard.LiveData", "Live data");
        public static string Date => UiText.Get("OperationsDashboard.Date", "Date");
        public static string FromDate => UiText.Get("OperationsDashboard.FromDate", "From date");
        public static string ToDate => UiText.Get("OperationsDashboard.ToDate", "To date");
        public static string Stations => UiText.Get("OperationsDashboard.Stations", "Stations");
        public static string AllStations => UiText.Get("OperationsDashboard.AllStations", "All stations");
        public static string Customers => UiText.Get("OperationsDashboard.Customers", "Customers");
        public static string AllCustomers => UiText.Get("OperationsDashboard.AllCustomers", "All customers");
        public static string PerformedServices => UiText.Get("OperationsDashboard.PerformedServices", "Performed services");
        public static string AllServices => UiText.Get("OperationsDashboard.AllServices", "All performed services");
        public static string ItemsSelected => UiText.Get("OperationsDashboard.ItemsSelected", "items selected");
        public static string FilterLogicHint => UiText.Get("OperationsDashboard.FilterLogicHint", "Station, customer, and service selections are combined to narrow all results.");
        public static string Reset => UiText.Get("OperationsDashboard.Reset", "Reset");
        public static string ClearFilters => UiText.Get("OperationsDashboard.ClearFilters", "Clear filters");
        public static string ApplyFilters => UiText.Get("OperationsDashboard.ApplyFilters", "Apply filters");
        public static string DataUnavailable => UiText.Get("OperationsDashboard.DataUnavailable", "Dashboard data is currently unavailable.");
        public static string StaleWarning => UiText.Get("OperationsDashboard.StaleWarning", "We couldn't refresh the latest data. The last successful results remain displayed.");
        public static string Retry => UiText.Get("OperationsDashboard.Retry", "Retry");
        public static string OperationalSnapshot => UiText.Get("OperationsDashboard.OperationalSnapshot", "Operational snapshot");
        public static string FlightStatus => UiText.Get("OperationsDashboard.FlightStatus", "Flight status");
        public static string FlightStatusDescription => UiText.Get("OperationsDashboard.FlightStatusDescription", "Flight counts and percentages by current operational status.");
        public static string FlightsWithPerformedServices => UiText.Get("OperationsDashboard.FlightsWithPerformedServices", "Flights with performed services");
        public static string StatusMixTitle => UiText.Get("OperationsDashboard.StatusMixTitle", "Status distribution");
        public static string StatusMixDescription => UiText.Get("OperationsDashboard.StatusMixDescription", "Share of filtered flights in each operational status.");
        public static string Distribution => UiText.Get("OperationsDashboard.Distribution", "Distribution");
        public static string FlightDistribution => UiText.Get("OperationsDashboard.FlightDistribution", "Flight distribution");
        public static string FlightDistributionDescription => UiText.Get("OperationsDashboard.FlightDistributionDescription", "Top stations, customers, and performed services in the selected period.");
        public static string StationDistribution => UiText.Get("OperationsDashboard.StationDistribution", "Flights by station");
        public static string StationDistributionDescription => UiText.Get("OperationsDashboard.StationDistributionDescription", "Each station's share of the matching flights.");
        public static string LandingMode => UiText.Get("OperationsDashboard.LandingMode", "Per Landing vs On Call");
        public static string LandingModeDescription => UiText.Get("OperationsDashboard.LandingModeDescription", "Landing mode for flights assigned to aircraft services.");
        public static string DesignatedFlights => UiText.Get("OperationsDashboard.DesignatedFlights", "Designated flights");
        public static string PerLanding => UiText.Get("OperationsDashboard.PerLanding", "Per Landing");
        public static string OnCall => UiText.Get("OperationsDashboard.OnCall", "On Call");
        public static string NoLandingModeFlights => UiText.Get("OperationsDashboard.NoLandingModeFlights", "No Per Landing or On Call flights match these filters.");
        public static string OperationTypeDistribution => UiText.Get("OperationsDashboard.OperationTypeDistribution", "Flights by operation type");
        public static string OperationTypeDistributionDescription => UiText.Get("OperationsDashboard.OperationTypeDistributionDescription", "Operation mix with Ad Hoc flights listed first.");
        public static string TopStations => UiText.Get("OperationsDashboard.TopStations", "Top stations");
        public static string TopStationsDescription => UiText.Get("OperationsDashboard.TopStationsDescription", "Flights by station, with remaining stations grouped as Other.");
        public static string TopCustomers => UiText.Get("OperationsDashboard.TopCustomers", "Top customers");
        public static string TopCustomersDescription => UiText.Get("OperationsDashboard.TopCustomersDescription", "Flights by customer, with remaining customers grouped as Other.");
        public static string TopFourCustomers => UiText.Get("OperationsDashboard.TopFourCustomers", "Top 4 customers");
        public static string TopFourCustomersDescription => UiText.Get("OperationsDashboard.TopFourCustomersDescription", "Flight count and share for the leading four customers; all others are grouped.");
        public static string PerformedServicesDescription => UiText.Get("OperationsDashboard.PerformedServicesDescription", "Distinct flights using each performed service; percentages show the share of all service usage. Remaining services are grouped as Other.");
        public static string TopFourServices => UiText.Get("OperationsDashboard.TopFourServices", "Top 4 services");
        public static string TopFourServicesDescription => UiText.Get("OperationsDashboard.TopFourServicesDescription", "Flight usage for the leading four performed services; all others are grouped.");
        public static string NoFlightData => UiText.Get("OperationsDashboard.NoFlightData", "No flight data");
        public static string NoMatchingActivity => UiText.Get("OperationsDashboard.NoMatchingActivity", "No activity matches the selected dashboard filters.");
        public static string Other => UiText.Get("OperationsDashboard.Other", "Other");
        public static string GroupedFormat => UiText.Get("OperationsDashboard.GroupedFormat", "{0} grouped");
        public static string TotalServiceUses => UiText.Get("OperationsDashboard.TotalServiceUses", "Total service uses");
        public static string TemporalAnalysis => UiText.Get("OperationsDashboard.TemporalAnalysis", "Temporal analysis");
        public static string FlightTrends => UiText.Get("OperationsDashboard.FlightTrends", "Flight trends");
        public static string FlightTrendsDescription => UiText.Get("OperationsDashboard.FlightTrendsDescription", "Flight volume automatically grouped by hour, day, or month for the selected range.");
        public static string ZoomHint => UiText.Get("OperationsDashboard.ZoomHint", "Scroll to zoom · drag to pan");
        public static string FlightsByHour => UiText.Get("OperationsDashboard.FlightsByHour", "Flights by hour");
        public static string FlightsByHourDescription => UiText.Get("OperationsDashboard.FlightsByHourDescription", "Flight count grouped by hour of day.");
        public static string FlightsByMonth => UiText.Get("OperationsDashboard.FlightsByMonth", "Flights by month");
        public static string FlightsByMonthDescription => UiText.Get("OperationsDashboard.FlightsByMonthDescription", "Flight count grouped by calendar month.");
        public static string FlightsByYear => UiText.Get("OperationsDashboard.FlightsByYear", "Flights by year");
        public static string FlightsByYearDescription => UiText.Get("OperationsDashboard.FlightsByYearDescription", "Flight count grouped by year.");
        public static string NoTrendData => UiText.Get("OperationsDashboard.NoTrendData", "No flight data is available for this view.");
        public static string FlightRegister => UiText.Get("OperationsDashboard.FlightRegister", "Flight register");
        public static string FlightsTable => UiText.Get("OperationsDashboard.FlightsTable", "Flights");
        public static string FlightsTableDescription => UiText.Get("OperationsDashboard.FlightsTableDescription", "View-only flight records matching the active dashboard filters.");
        public static string TableUnavailable => UiText.Get("OperationsDashboard.TableUnavailable", "Flight records are currently unavailable.");
        public static string Flights => UiText.Get("OperationsDashboard.Flights", "Flights");
        public static string NoFlights => UiText.Get("OperationsDashboard.NoFlights", "No flights match the selected filters.");
        public static string Export => UiText.Get("OperationsDashboard.Export", "Export");
        public static string Exporting => UiText.Get("OperationsDashboard.Exporting", "Exporting...");
        public static string ExcelWorkbook => UiText.Get("OperationsDashboard.ExcelWorkbook", "Excel workbook (.xlsx)");
        public static string CsvFile => UiText.Get("OperationsDashboard.CsvFile", "CSV file (.csv)");
        public static string FlightNumber => UiText.Get("OperationsDashboard.FlightNumber", "Flight number");
        ...
        public static string Live => UiText.Get("OperationsDashboard.Live", "Live");
        public static string LiveInterrupted => UiText.Get("OperationsDashboard.LiveInterrupted", "Live update interrupted");
        public static string WaitingForData => UiText.Get("OperationsDashboard.WaitingForData", "Waiting for data");
        public static string LiveToday => UiText.Get("OperationsDashboard.LiveToday", "Live data for today");
        public static string LiveModeDescription => UiText.Get("OperationsDashboard.LiveModeDescription", "Updates immediately as operational data changes.");
        public static string YesterdayDescription => UiText.Get("OperationsDashboard.YesterdayDescription", "Shows the previous calendar day, which is the default dashboard view.");
        public static string LiveTodayFormat => UiText.Get("OperationsDashboard.LiveTodayFormat", "Live today · {0}");
        public static string YesterdayFormat => UiText.Get("OperationsDashboard.YesterdayFormat", "Yesterday · {0}");
        public static string PeriodFormat => UiText.Get("OperationsDashboard.PeriodFormat", "{0} – {1}");
        public static string UpdatedAtFormat => UiText.Get("OperationsDashboard.UpdatedAtFormat", "Updated at {0}");
        public static string InvalidPeriod => UiText.Get("OperationsDashboard.InvalidPeriod", "Invalid date range");
        public static string InvalidPeriodDescription => UiText.Get("OperationsDashboard.InvalidPeriodDescription", "The end date must be on or after the start date.");
        public static string ExportReady => UiText.Get("OperationsDashboard.ExportReady", "Export ready");
        public static string ExportReadyDescription => UiText.Get("OperationsDashboard.ExportReadyDescription", "Your dashboard flight export has been downloaded.");
        public static string ExportFailed => UiText.Get("OperationsDashboard.ExportFailed", "Export failed");
        public static string ExportFailedDescription => UiText.Get("OperationsDashboard.ExportFailedDescription", "The dashboard flight export could not be generated. Please try again.");
    }
    ...
    public static class Users
    {
        ...
        public static string ChangeAccess => UiText.Get("Users.ChangeAccess", "Change access");
        ...
        public static string ChangeAccessTitle => UiText.Get("Users.ChangeAccessTitle", "Change access");
        public static string ChangeAccessIntro => UiText.Get("Users.ChangeAccessIntro", "Review and change the account type or role for {0}.");
        public static string CurrentAccess => UiText.Get("Users.CurrentAccess", "Current access");
        public static string NewAccess => UiText.Get("Users.NewAccess", "New access");
        public static string SelectRole => UiText.Get("Users.SelectRole", "Select a role");
        public static string LoadingCompatibleRoles => UiText.Get("Users.LoadingCompatibleRoles", "Loading compatible roles...");
        public static string RolesLoadFailed => UiText.Get("Users.RolesLoadFailed", "Roles could not be loaded");
        public static string RetryLoadingRoles => UiText.Get("Users.RetryLoadingRoles", "Retry");
        public static string NoCompatibleRolesHint => UiText.Get("Users.NoCompatibleRolesHint", "Create a compatible role before changing this user's access.");
        public static string ChangeAccountTypePermissionRequired => UiText.Get("Users.ChangeAccountTypePermissionRequired", "Your role can assign roles but cannot change this account's type.");
        public static string LinkedAccountTypeImmutable => UiText.Get("Users.LinkedAccountTypeImmutable", "This account type is linked to its MasterData record and cannot be changed here.");
        public static string ElevationWarning => UiText.Get("Users.ElevationWarning", "This promotes the user to System Administrator. The selected role may grant write and administrative permissions.");
        public static string DemotionWarning => UiText.Get("Users.DemotionWarning", "This removes administrative access and makes the account globally read-only. The last sign-in-capable holder of the protected System Administrator role cannot be changed.");
        public static string AccessChangeSessionWarning => UiText.Get("Users.AccessChangeSessionWarning", "Active sessions will be revoked so the new access takes effect. The user must sign in again.");
        public static string ConfirmAccessChange => UiText.Get("Users.ConfirmAccessChange", "Change {0}'s access to {1} with the {2} role? Active sessions will be signed out.");
        public static string CannotChangeOwnAccess => UiText.Get("Users.CannotChangeOwnAccess", "You cannot change your own account access.");
        public static string AccessChangeForbidden => UiText.Get("Users.AccessChangeForbidden", "You do not have permission to change this user's access.");
        public static string ChangeAccountTypeForbidden => UiText.Get("Users.ChangeAccountTypeForbidden", "You can assign a role, but you do not have permission to change the account type.");
        public static string AccountTypeTransitionNotAllowed => UiText.Get("Users.AccountTypeTransitionNotAllowed", "This account type cannot be changed to the selected type.");
        public static string LastAdministratorRequired => UiText.Get("Users.LastAdministratorRequired", "At least one sign-in-capable holder of the protected System Administrator role must remain.");
        public static string PermissionDelegationForbidden => UiText.Get("Users.PermissionDelegationForbidden", "You cannot assign a role that grants permissions you do not hold.");
        public static string ManagedRoleForbidden => UiText.Get("Users.ManagedRoleForbidden", "You cannot change this user because their current role grants permissions you do not hold.");
        public static string SelectedRoleUnavailable => UiText.Get("Users.SelectedRoleUnavailable", "The selected role is no longer available. The role list was refreshed; choose again.");
        public static string DeactivatedAccessImmutable => UiText.Get("Users.DeactivatedAccessImmutable", "Access cannot be changed for a deactivated account.");
        public static string AccessChangedConcurrently => UiText.Get("Users.AccessChangedConcurrently", "Another administrator changed this user. Close the dialog, reload the user, and review the latest access.");
        public static string AccessChangedSuccess => UiText.Get("Users.AccessChangedSuccess", "User access changed. Any active sessions were signed out.");
