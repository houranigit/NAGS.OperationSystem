...
/// <summary>Builds a detached printable snapshot for approved downloads and submission receipts.</summary>
public sealed class WorkOrderPrintSourceBuilder(IFileStorage storage, IMasterDataReader masterData)
{
    public async Task<ApprovedWorkOrderPrintDto> BuildAsync(
        WorkOrder workOrder,
        Flight flight,
