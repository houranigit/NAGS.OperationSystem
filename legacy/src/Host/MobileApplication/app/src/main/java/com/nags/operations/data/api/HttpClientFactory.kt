        ...
        install(Auth) {
            bearer {
                ...
                refreshTokens {
                    ...
                    try {
                        val response = refreshClient.post(url("api/identity/auth/refresh")) {
                        ...
                        if (!response.status.isSuccess()) {
                            ...
                            tokenStore.saveTokensAfterRefresh(
                                ...
                                accessExpiresAt = body.accessTokenExpiresAt,
                ...
                sendWithoutRequest { request ->
                    ...
                    !path.contains("/api/identity/auth/login") &&
                        !path.contains("/api/identity/auth/refresh")
                }
            }
        }
    }
