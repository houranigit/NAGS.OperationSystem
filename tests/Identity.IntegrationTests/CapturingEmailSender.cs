...
/// <summary>
/// Captures emails at the real delivery boundary. Invitations now flow through the durable email
/// outbox (encrypted body) and are sent here, so tests obtain the raw activation token by parsing
/// the delivered message after draining the outbox.
/// </summary>
