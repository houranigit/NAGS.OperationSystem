...
/// the genuine stack (all module migrations and seeding run on startup). Requires Docker to be available.
/// </summary>
public sealed class OperationsApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public const string MasterDataBase = "/api/v1/masterdata";
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseSetting("Notifications:Fcm:Enabled", "false");
        builder.UseSetting("Operations:FlightReminders:Enabled", "false");
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Notifications:Fcm:Enabled"] = "false",
                ["Operations:FlightReminders:Enabled"] = "false",
    ...
    public async Task<HttpClient> CreateAuthenticatedAdminClientAsync()
    {
        ...
        await EnsureMfaAsync(client);
        return client;
    }

    /// <summary>Logs in an already-activated user and completes MFA enrollment when needed.</summary>
    ...
    private async Task EnsureMfaAsync(HttpClient client)
    {
    ...
    /// <summary>Synchronously drains every module outbox so cross-module flows complete deterministically.</summary>
